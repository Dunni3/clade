...
echo ""
echo "Other services:"
echo "  docker compose -f docker/docker-compose.test.yml exec conductor bash"
echo "  curl http://ember:8100/health          # from inside any container"
echo "  curl http://hearth:8000/api/v1/health   # from inside any container"
echo ""
