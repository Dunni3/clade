...
1. **Personal** (`clade-personal`) — Coordinator with mailbox, brother listing, SSH task delegation, and ember tools (e.g. Doot)
...
**Personal server** should have tools for: mailbox, tasks, brothers, ember.
