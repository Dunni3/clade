...
def generate_personal_identity(
    ...
    lines.append("- `initiate_ember_task` — Delegate a task to a brother via Ember")
    lines.append("- `check_ember_health` — Check Ember health (by brother name, URL, or all)")
    lines.append("- `list_ember_tasks` — List active Ember tasks (by brother name or all)")
